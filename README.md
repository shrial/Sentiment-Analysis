# Sentiment-Analysis
A full-stack web application that classifies the sentiment of a movie review as positive or negative using a machine learning model trained with Scikit-learn.
